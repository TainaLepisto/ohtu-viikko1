...
public class VarastoTest {
    ...
    @Test
    public void konstruktoriNegatiisivellaTilavuudellaLuoTyhjanVaraston() {
        varasto2 = new Varasto(-1);
        assertEquals(0, varasto2.getSaldo(), vertailuTarkkuus);
    }

    @Test
    public void konstruktoriAlkuSaldollaLuoTyhjanVaraston() {
    ...
    @Test
    public void konstruktoriAlkuSaldollaLuoVarastonOIkein() {
    ...
    @Test
    public void konstruktoriAlkuSaldollaNollaanLiianPienenTilavuuden() {
    ...
    @Test
    public void konstruktoriLiianIsollaAlkuSaldollaLuoVarastonOIkein() {
    ...
    @Test
    public void liianIsoOttaminenPalauttaaOikeanMaaran() {
        varasto.lisaaVarastoon(8);
